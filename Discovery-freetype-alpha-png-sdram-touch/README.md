This project displays a series of touch-sensitive png icons, arranged on a background bitmap image, using the LodePNG library and the tft screen built-in touch sensor.
