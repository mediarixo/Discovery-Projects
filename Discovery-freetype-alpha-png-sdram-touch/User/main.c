...
int main(void) {
	...
	while (1) {
		...
		/* Check if pressed */
		if (TS.NumPresses) {
			if ((TS.X[0] > 10) && (TS.X[0] < 58) && (TS.Y[0] > 10) && (TS.Y[0] < 58)) {
			//fillScreen(LCD_COLOR_WHITE);		/* slower than Dma 2D fill routine */
			TM_LCD_Fill(LCD_COLOR_WHITE);   	Delayms(1000);  readBuffer();
//			  printf("HIT --> X: %3d Y: %3d\r\n", TS.X[0], TS.Y[0]);	
			}	  
			if ((TS.X[0] > 68) && (TS.X[0] < 68+48) && (TS.Y[0] > 10) && (TS.Y[0] < 58)) {
			  TM_LCD_Fill(LCD_COLOR_BLACK);		Delayms(1000);   readBuffer(); }	 
			if ((TS.X[0] > 126) && (TS.X[0] < 126+48) && (TS.Y[0] > 10) && (TS.Y[0] < 58)) {
			  TM_LCD_Fill(LCD_COLOR_RED);		Delayms(1000);   readBuffer(); }	 
			
			if ((TS.X[0] > 10) && (TS.X[0] < 58) && (TS.Y[0] > 68) && (TS.Y[0] < 68+48)) {
			  TM_LCD_Fill(LCD_COLOR_GREEN);		Delayms(1000);  readBuffer();  }	  
			if ((TS.X[0] > 68) && (TS.X[0] < 68+48) && (TS.Y[0] > 68) && (TS.Y[0] < 68+48)) {
			  TM_LCD_Fill(LCD_COLOR_GREEN2);		Delayms(1000);   readBuffer(); }	 
			if ((TS.X[0] > 126) && (TS.X[0] < 126+48) && (TS.Y[0] > 68) && (TS.Y[0] < 68+48)) {
			  TM_LCD_Fill(LCD_COLOR_BLUE);		Delayms(1000);   readBuffer(); }	 
			
			if ((TS.X[0] > 10) && (TS.X[0] < 58) && (TS.Y[0] > 126) && (TS.Y[0] < 126+48)) {
			  TM_LCD_Fill(LCD_COLOR_BLUE2);		Delayms(1000);  readBuffer();  }	  
			if ((TS.X[0] > 68) && (TS.X[0] < 68+48) && (TS.Y[0] > 126) && (TS.Y[0] < 126+48)) {
			  TM_LCD_Fill(LCD_COLOR_YELLOW);		Delayms(1000);   readBuffer(); }	 
			if ((TS.X[0] > 126) && (TS.X[0] < 126+48) && (TS.Y[0] > 126) && (TS.Y[0] < 126+48)) {
			  TM_LCD_Fill(LCD_COLOR_ORANGE);		Delayms(1000);   readBuffer(); }	 
