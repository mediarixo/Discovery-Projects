 ...
 *	        Reworked implementation for STM32F7
@verbatim
   ----------------------------------------------------------------------
...
struct __FILE {
  ...
  FIL* fil;															 /* reworked code for stm32f7 device! */
	FSIZE_t ofs;                           /* reworked code for stm32f7 device! */
};
 ...
 * - adding fopen, fclose, fputs, fgets, fread i/o functions implementation
 *
 */ 
